 ...
 */
@JsonSerialize(as = ImmutableSummaryClassReflectionConfig.class)
@Value.Immutable
public interface SummaryClassReflectionConfig extends ReflectionConfigElement {
    ...
    static ImmutableSummaryClassReflectionConfig.Builder builder() {
        return ImmutableSummaryClassReflectionConfig.builder();
    }
}
