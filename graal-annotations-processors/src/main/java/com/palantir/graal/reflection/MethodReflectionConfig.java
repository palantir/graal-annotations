 ...
 */
@JsonSerialize(as = ImmutableMethodReflectionConfig.class)
@Value.Immutable
public interface MethodReflectionConfig {
    String name();
    List<String> parameterTypes();

    static ImmutableMethodReflectionConfig.Builder builder() {
        return ImmutableMethodReflectionConfig.builder();
    }
}
