 ...
 */
@JsonSerialize(as = ImmutableSpecificClassReflectionConfig.class)
@Value.Immutable
public interface SpecificClassReflectionConfig extends ReflectionConfigElement {
    List<FieldReflectionConfig> fields();
